...
const it: Translations = {
  ...
  recipe: {
    ...
    portions: 'Porzioni',
    portionsAdjusted: 'Adattato da {{original}}',
    portionsReset: 'Ripristina',
    decreasePortions: 'Diminuisci porzioni',
    increasePortions: 'Aumenta porzioni',
    resetPortions: 'Ripristina a {{count}} porzioni',
    ...
    addToOthers: 'Aggiungi ad Altro',
    addedToOthers: 'Aggiunto!',
    addedToOthersMessage: '{{title}} aggiunto alla sezione Altro',
  ...
  settings: {
    ...
    generalSettingsDesc: 'Preferenze di visualizzazione e aspetto',
    householdSettings: 'Impostazioni nucleo familiare',
    householdSettingsDesc: 'Lingua, porzioni, membri e altro',
    aiSettings: 'Miglioramenti AI',
    aiSettingsDesc: 'Preferenze dietetiche, attrezzature e miglioramento AI',
    ...
    suggestedItems: {
      ...
      vegetableOil: 'Olio di semi',
      butter: 'Burro',
      sugar: 'Zucchero',
      flour: 'Farina',
      garlic: 'Aglio',
      onion: 'Cipolla',
      soySauce: 'Salsa di soia',
      vinegar: 'Aceto',
      honey: 'Miele',
      rice: 'Riso',
      pasta: 'Pasta',
    ...
    noteSuggestions: 'Suggerimenti note',
    noteSuggestionsDesc: 'Tag rapidi per le note del menu settimanale',
    yourSuggestions: 'I tuoi suggerimenti ({{count}})',
    addSuggestionPlaceholder: 'Aggiungi un suggerimento (es. Avanzi)',
    noSuggestionsYet: 'Nessun suggerimento ancora',
    addSuggestionsHint: 'Aggiungi tag rapidi per le note del menu',
    adminSection: 'Admin',
    ...
    weekStartTuesday: 'Martedì',
    weekStartWednesday: 'Mercoledì',
    weekStartThursday: 'Giovedì',
    weekStartFriday: 'Venerdì',
  ...
  householdSettings: {
    ...
    dietary: {
      ...
      dietPescatarianDesc: 'Niente carne, ma pesce e frutti di mare vanno bene',
      dietVegetarian: 'Vegetariano',
      dietVegetarianDesc: 'Niente carne o pesce, latticini e uova vanno bene',
      dietVegan: 'Vegano',
      dietVeganDesc: 'Nessun prodotto di origine animale',
      ...
      originalPlaceholder: 'es. pollo',
      replacementPlaceholder: 'es. Quorn',
      meatSubstitute: 'Sostituto carne',
      meatSubstituteDesc:
        'Applicare solo quando il nucleo ha porzioni vegetariane',
      addReplacement: 'Aggiungi sostituzione',
      maxReplacements: 'Massimo {{max}} sostituzioni',
      dairy: 'Latticini',
    ...
    equipment: {
      ...
      items: {
        ...
        stand_mixer: 'Planetaria',
        food_processor: 'Robot da cucina',
        immersion_blender: 'Frullatore a immersione',
        pressure_cooker: 'Pentola a pressione',
        slow_cooker: 'Slow cooker',
        sous_vide: 'Sous vide',
        pasta_machine: 'Macchina per la pasta',
        pizza_oven: 'Forno per pizza',
        convection_oven: 'Forno ventilato',
        grill_function: 'Grill',
        steam_oven: 'Forno a vapore',
        dutch_oven: 'Casseruola in ghisa',
        cast_iron_skillet: 'Padella in ghisa',
        wok: 'Wok',
        pizza_stone: 'Pietra refrattaria',
        probe_thermometer: 'Termometro a sonda',
  ...
  featured: {
    ...
    'veggie-delights': 'Delizie vegetariane',
    'seafood-picks': 'Piatti di pesce',
    'slow-cooked': 'Cottura lenta',
    'quick-and-easy': 'Veloce e facile',
    'wok-and-stir-fry': 'Wok e saltati',
    'curry-night': 'Serata curry',
    'bowl-food': 'Bowl',
    'baking-and-bread': 'Pane e dolci',
    'date-night': 'Cena romantica',
    'spicy-and-bold': 'Piccante e deciso',
    'lunchbox-ideas': 'Idee per il pranzo',
    'mexican-fiesta': 'Fiesta messicana',
    'nordic-classics': 'Classici nordici',
