...
const en = {
  ...
  recipe: {
    ...
    portions: 'Portions',
    portionsAdjusted: 'Adjusted from {{original}}',
    portionsReset: 'Reset',
    decreasePortions: 'Decrease portions',
    increasePortions: 'Increase portions',
    resetPortions: 'Reset to {{count}} portions',
    ...
    addToOthers: 'Add to Other',
    addedToOthers: 'Added!',
    addedToOthersMessage: '{{title}} added to Other section',
  ...
  settings: {
    ...
    generalSettingsDesc: 'Display preferences and appearance',
    householdSettings: 'Household Settings',
    householdSettingsDesc: 'Language, portions, members & more',
    aiSettings: 'AI Improvements',
    aiSettingsDesc: 'Dietary preferences, equipment & AI enhancement',
  ...
  householdSettings: {
    ...
    dietary: {
      ...
      dietPescatarianDesc: 'No meat, but fish and seafood are fine',
      dietVegetarian: 'Vegetarian',
      dietVegetarianDesc: 'No meat or fish, dairy and eggs are fine',
      dietVegan: 'Vegan',
      dietVeganDesc: 'No animal products at all',
      ...
      originalPlaceholder: 'e.g., chicken',
      replacementPlaceholder: 'e.g., Quorn',
      meatSubstitute: 'Meat substitute',
      meatSubstituteDesc: 'Only apply when household has vegetarian portions',
      addReplacement: 'Add replacement',
      maxReplacements: 'Maximum {{max}} replacements',
      dairy: 'Dairy',
    ...
    groceryStores: {
      ...
      subtitle: 'Add your stores to learn their layout over time',
      yourStores: 'Your stores ({{count}})',
      addPlaceholder: 'Add a store...',
      noStoresYet: 'No stores added',
      addStoresHint: 'Add your stores to sort grocery lists by aisle',
    },
  ...
  featured: {
    ...
    'seafood-picks': 'Seafood Picks',
    'slow-cooked': 'Slow-Cooked',
    'quick-and-easy': 'Quick & Easy',
    'wok-and-stir-fry': 'Wok & Stir-Fry',
    'curry-night': 'Curry Night',
    'bowl-food': 'Bowl Food',
    'baking-and-bread': 'Baking & Bread',
    'date-night': 'Date Night',
    'spicy-and-bold': 'Spicy & Bold',
    'lunchbox-ideas': 'Lunchbox Ideas',
    'mexican-fiesta': 'Mexican Fiesta',
    'nordic-classics': 'Nordic Classics',
