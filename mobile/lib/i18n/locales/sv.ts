...
const sv: Translations = {
  ...
  recipe: {
    ...
    addToOthers: 'Lägg till i Övrigt',
    addedToOthers: 'Tillagt!',
    addedToOthersMessage: '{{title}} tillagt i Övrigt',
    pleaseWait: 'Vänta',
  ...
  grocery: {
    ...
    clearPicked: 'Klar med handlingen?',
    clearPickedButton: 'Klar med handlingen',
    clearPickedMessage: 'Plockade varor tas bort från listan.',
    clearPickedConfirm: 'Klar',
  ...
  featured: {
    ...
    'veggie-delights': 'Gröna favoriter',
    'seafood-picks': 'Fisk & skaldjur',
    'slow-cooked': 'Långkok',
    'quick-and-easy': 'Snabbt & enkelt',
    'wok-and-stir-fry': 'Wok & wokning',
    'curry-night': 'Currykväll',
    'bowl-food': 'Bowls',
    'baking-and-bread': 'Bakning & bröd',
    'date-night': 'Dejtkväll',
    'spicy-and-bold': 'Hett & kryddigt',
    'lunchbox-ideas': 'Matlådstips',
    'mexican-fiesta': 'Mexikansk fiesta',
    'nordic-classics': 'Nordiska klassiker',
    'middle-eastern': 'Mellanöstern',
    scrollBack: 'Scrolla bakåt',
    scrollForward: 'Scrolla framåt',
  },
};
