...
const SUPPORTED_SITES = [
  ...
  'Food Network', 'Serious Eats', 'NYT Cooking', 'Tasty',
];

export default function AddRecipeScreen() {
  const actions = useAddRecipeActions();
  const {
    t, isManualMode, url, setUrl, enhanceWithAI, setEnhanceWithAI,
    handleImport, isPending,
  } = actions;
        ...
        >
          ...
          <View style={{
            ...
            <View style={{ flexDirection: 'row', alignItems: 'center', flex: 1 }}>
              <View style={{
                width: iconContainer.md, height: iconContainer.md, borderRadius: iconContainer.md / 2,
          ...
          <View style={{ marginTop: spacing['3xl'] }}>
            ...
            <View style={{ flexDirection: 'row', flexWrap: 'wrap', gap: spacing.sm }}>
              {[...SUPPORTED_SITES, t('addRecipe.andMore')].map((site) => (
                <View key={site} style={{ backgroundColor: colors.glass.card, paddingHorizontal: spacing.md, paddingVertical: spacing.sm, borderRadius: borderRadius.sm }}>
