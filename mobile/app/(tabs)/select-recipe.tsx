  ...
  return (
    <>
      ...
      <GradientBackground style={{ flex: 1 }}>
            ...
            <View style={{ flexDirection: 'row', gap: spacing.xs }}>
              ...
              <Pressable
                ...
                style={({ pressed }) => ({
                  ...
                  borderRadius: borderRadius.sm,
                  backgroundColor:
                    activeTab === 'quick' ? colors.primary : colors.glass.light,
                  alignItems: 'center',
                  transform: [{ scale: pressed ? 0.98 : 1 }],
                })}
              >
              ...
              <Pressable
                ...
                style={({ pressed }) => ({
                  ...
                  borderRadius: borderRadius.sm,
                  backgroundColor:
                    activeTab === 'copy' ? colors.primary : colors.glass.light,
                  alignItems: 'center',
                  transform: [{ scale: pressed ? 0.98 : 1 }],
                })}
              >
                <Text
                  style={{
                    ...
                    fontWeight: '600',
                    color:
                      activeTab === 'copy' ? colors.white : colors.text.inverse,
                  }}
                >
                  📋 Copy
                </Text>
        ...
        {/* Remove meal button */}
        <View
          style={{ padding: spacing.lg, backgroundColor: colors.glass.card }}
        >
          <Pressable
