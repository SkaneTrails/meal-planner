...
vi.mock('@/lib/theme', () => {
  ...
  const mockLightTheme = {
    ...
    overrides: { checkedOpacity: 0.85, checkboxBorderWidth: 2, dashedBorderWidth: 1.5, cardBorderWidth: 1, cardHighlightBorderWidth: 2, segmentedControlGap: 8, segmentedControlPadding: 4, segmentedControlActiveIndicator: 'shadow', chipToggleGap: 8 },
  ...
  const mockTerminalTheme = {
    ...
    overrides: { checkedOpacity: 0.7, checkboxBorderWidth: 1, dashedBorderWidth: 0, cardBorderWidth: 0, cardHighlightBorderWidth: 0, segmentedControlGap: 0, segmentedControlPadding: 0, segmentedControlActiveIndicator: 'underline', chipToggleGap: 0 },
