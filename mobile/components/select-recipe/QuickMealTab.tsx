...
export const QuickMealTab = ({ state }: QuickMealTabProps) => {
  const { t, customText, setCustomText, handleSetCustomText, setMeal, handleRemoveMeal, removeMeal } = state;
    ...
    <View style={{ flex: 1, padding: spacing.xl }}>
      <View style={{
        ...
        <View style={{ alignItems: 'center', marginBottom: spacing.xl }}>
          ...
          <Text style={{ fontSize: fontSize.lg, color: colors.gray[600], marginTop: spacing.sm }}>
        ...
        <Pressable
          ...
          style={({ pressed }) => ({
            backgroundColor: customText.trim() ? (pressed ? '#5A7A5A' : '#6B8E6B') : colors.gray[300],
